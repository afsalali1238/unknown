...
*surprise + substance*, not outrage. If a card isn't interesting enough to stop the thumb, it
...
- **A (recommended):** rename Home→**Feed** as the landing surface's *sibling*, giving
...
North-star: *depth-expand rate* and *saves per session* — not raw swipe count. Optimizing for swipes
...
- **Filter bubble:** the 25% serendipity slice is non-negotiable — it's what makes it *reading*, not a rut.
