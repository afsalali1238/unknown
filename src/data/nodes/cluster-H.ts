...
export const CLUSTER_H: Node[] = [
  {
    ...
    quiz: {
      ...
      options: [
        "Every transaction requires a government ID to verify identity — this view emphasizes the same outcome but attributes it to a different underlying mechanism ",
        "Transactions are limited to once per day per user — this view emphasizes the same outcome but attributes it to a different underlying mechanism that the sou",
        ...
        "A single trusted server verifies every transaction centrally — this view emphasizes the same outcome but attributes it to a different underlying mechanism t",
      ],
      correctIndex: 2,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "Because Bitcoin was never intended to be used as money at all — this view emphasizes the same outcome but attributes it to a different underlying mechanism that the source mate",
        "Because government regulation legally prohibits using Bitcoin for purchases — this view emphasizes the same outcome but attributes it to a different underlying mechanism that t",
        "Because Bitcoin's supply is unlimited, unlike gold — this view emphasizes the same outcome but attributes it to a different underlying mechanism that the source material explic",
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "To generate charitable donations for the Ethereum Foundation — this view emphasizes the same outcome but attributes it to a different underlying m",
        "To convert Ether into Bitcoin automatically during each transaction — this view emphasizes the same outcome but attributes it to a different under",
        "Because Ethereum has no consensus mechanism and needs fees to select validators randomly — this view emphasizes the same outcome but attributes it",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "Because crypto applications are illegal in most jurisdictions — this view emphasizes the same outcome but attributes it to a different underlying mechanism ",
        ...
        "Because protocols require government licensing fees that applications don't — this view emphasizes the same outcome but attributes it to a different underly",
        "Because applications on blockchains cannot generate any revenue at all — this view emphasizes the same outcome but attributes it to a different underlying m",
      ],
      correctIndex: 1,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "A central Uniswap server sets prices manually based on other exchanges — this view emphasizes the same outcome but attributes it to a different underlying m",
        "Prices are fixed permanently when the pool is created and never change — this view emphasizes the same outcome but attributes it to a different underlying m",
        ...
        "Every trade requires a human liquidity provider to personally approve the price — this view emphasizes the same outcome but attributes it to a different und",
      ],
      correctIndex: 2,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "It encrypts transaction contents so no one can see them — this view emphasizes the same outcome but attributes it to a different und",
        "It eliminates the need for any validators on the network — this view emphasizes the same outcome but attributes it to a different un",
        "It converts all transactions into a single batched transaction per day — this view emphasizes the same outcome but attributes it to ",
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "Because governments force platforms to extract more value once they reach a certain size — this view emphasizes the same outcome but attributes it to a different underlying mechan",
        "Because developers always eventually violate platform terms of service — this view emphasizes the same outcome but attributes it to a different underlying mechanism that the sourc",
        "Because centralized platforms run out of technical capacity as they grow — this view emphasizes the same outcome but attributes it to a different underlying mechanism that the sou",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "SPACs are legally required to have lower fees than IPOs — this view emphasizes the same outcome but attributes it to a different underlying mechanism that the ",
        ...
        "SPACs guarantee a higher stock price than a traditional IPO — this view emphasizes the same outcome but attributes it to a different underlying mechanism that ",
        "SPACs eliminate the need for any regulatory disclosure at all — this view emphasizes the same outcome but attributes it to a different underlying mechanism tha",
      ],
      correctIndex: 1,
      explanation:
