...
export const CLUSTER_Q: Node[] = [
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "It leverages the Zeigarnik Effect to create anxiety. — this view emphasi",
        "It relies on the Panic Monster to enforce deadlines. — this view emphasi",
        "It focuses on visualizing the end goal to generate motivation. — this vi",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "Wealth is measured by the visible assets you own — cars, houses, watches. — this view emphas",
        "Wealth is what you don't see: the income deliberately not converted into visible spending, left to compound instead.",
        "Wealth is primarily a function of income level, independent of spending habits. — this view ",
        "Wealth and being 'rich' are functionally the same thing in Housel's framework. — this view e",
      ],
      correctIndex: 1,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        "Eliminate the cue that triggers the habit entirely. — this view emphasiz",
        "Rely on willpower alone to suppress the routine until the habit fades. —",
        "Replace the reward with a larger, more motivating one. — this view empha",
