...
export const CLUSTER_AF: Node[] = [
  {
    ...
    quiz: {
      ...
      options: [
        "Early users pay lower prices due to promotional discounts — a widely circulated summary that inverts the relationship the author actually defends.",
        ...
        "Early adopters are naturally more skeptical people — an appealing shorthand that collapses a structural distinction into a surface similarity.",
        "Company marketing budgets are always smaller at launch — a plausible reading that overlooks the limiting condition the text stresses.",
      ],
      correctIndex: 1,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "That most chains never reached the target at all — a widely circulated summary that inverts the relationship the author actually defends.",
        "That every completed chain used exactly six intermediaries — a common simplification that omits the key mechanism behind the effect.",
        "That the experiment proved social networks are completely random — an appealing shorthand that collapses a structural distinction into a surface similarity.",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "Every node has roughly the same number of connections, forming a uniform random network It holds only within the scope the author defines, not as a universal claim.",
        "Scale-free networks have no hubs and their degree distribution is a perfect bell curve This reading skips the enabling condition that makes the mechanism work as stated.",
        "They are defined solely by having a large total number of nodes, regardless of connection pattern The distinction matters because it changes what you would.",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "Geographic distance, since humans can only physically meet about 150 people in a lifetime This reading skips the enabling condition that makes.",
        "A legal limit imposed by early human tribal law that was later culturally transmitted The distinction matters because it changes what you would.",
        "The number of hours in a day, which mathematically allows exactly 150 friendships Without that condition, the same evidence would be consistent.",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "When the network only supports one-to-one messaging and no group formation is allowed The distinction matters because it changes what you would.",
        "When groups are forbidden from forming and value comes only from broadcast Without that condition, the same evidence would be consistent with the.",
        "Reed's law always overstates by exactly 2×, so it never meaningfully differs from Metcalfe's It holds only within the scope the author defines,.",
      ],
      correctIndex: 0,
      explanation:
  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "Because the mean is the only statistic that matters, so groups with the same mean must always tip identically It holds only within the scope the author.",
        "Because cascades only depend on group size and threshold distribution plays no role This reading skips the enabling condition that makes the mechanism work as stated.",
        "Because threshold models predict every group will eventually cascade regardless of distribution The distinction matters because it changes what you would.",
      ],
      correctIndex: 0,
      explanation:
