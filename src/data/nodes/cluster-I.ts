  ...
  },
  {
    ...
    quiz: {
      ...
      options: [
        ...
        "A single corporation that secretly controls global markets through monopoly pricing",
        "A new form of artificial intelligence that will inevitably dominate humanity",
        "A historical empire that collapsed because its leaders were unusually cruel",
      ],
      correctIndex: 0,
      explanation:
