...
> Originally published by Stanford Encyclopedia of Philosophy, Stanford Encyclopedia of Philosophy — https://plato.stanford.edu/entries/buddha/
...
represented as a philosopher. First there are those (e.g. Albahari 2006) who (correctly) point out that the Buddha never categorically
...
2.  None of the five kinds of psychophysical element is
    permanent.
...
1.  If there were a self, one could never desire that it be
    changed.

2.  Each of the five kinds of psychophysical element is such that one
