---
title: "Are You Living in a Computer Simulation? (full paper)"
author: "simulation-argument.com"
source: "simulation-argument.com"
url: https://simulation-argument.com/simulation.html
retrieved: 2026-07-16
---

> Originally published by simulation-argument.com, simulation-argument.com — https://simulation-argument.com/simulation.html
...
by Nick Bostrom
        ...
        \(f_{sim} = \dfrac{f_P\ \overline{N}\ \overline{H}}{(f_P\ \overline{N}\ \overline{H}) + \overline{H}}\)
        ...
        and thus:
            ...
            \begin{equation}
            \tag{*}
            f_{sim} = \dfrac{f_P\ f_I\ \overline{N_I}}{(f_P\ f_I\ \overline{N_I}) + 1}
            \end{equation}
            \)
        ...
        I’m grateful to many people for comments, and especially to Amara Angelica, Robert Bradbury, Milan Cirkovic, Robin Hanson, Hal Finney, Robert A. Freitas Jr., John Leslie, Mitch Porter, Keith DeRose, Mike Treder, Mark Walker, Eliezer Yudkowsky, and several anonymous referees.
            ...
            [Nick Bostrom’s academic homepage: nickbostrom.com]
            [More on the simulation argument: simulation-argument.com]
                ...
                [4] R. J. Bradbury, “Matrioshka Brains.” Working manuscript (1999), http://www.aeiveos.com:8080/~bradbury/MatrioshkaBrains/MatrioshkaBrainsPaper.html.
                ...
                [10] 100 billion humans × 50 years/human × 30 million secs/year × [1014, 1017] operations in each human brain per second ≈ [1033, 1036] operations.
