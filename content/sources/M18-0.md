---
title: "Situational Awareness: The Decade Ahead (original essay)"
...
> Originally published by Leopold Aschenbrenner, 2024, Leopold Aschenbrenner, 2024 — https://situational-awareness.ai/
...
Introduction [this page]History is live in San Francisco.
...
IIIc. SuperalignmentReliably controlling AI systems much smarter than we are is an unsolved technical problem. And while it is a solvable problem, things could easily go off the rails during a rapid intelligence explosion. Managing this will be extremely tense; failure could easily be catastrophic.
...
V. Parting ThoughtsWhat if we’re right?
...
Next post in series: I.  From GPT-4 to AGI: Counting the OOMs
